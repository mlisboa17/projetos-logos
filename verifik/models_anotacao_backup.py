...
class ImagemUnificada(models.Model):
    ...
    versao_modelo = models.CharField(
        ...
        help_text="Versão do modelo YOLO em que foi treinada"
    )
    ...
    tipo_augmentacao = models.CharField(
        ...
        blank=True,
        default='',
        verbose_name="Tipo de Augmentação",
        help_text="Ex: rotacao_45, flip_horizontal, zoom_1.2, brightness_0.8"
    )
    
    num_augmentacoes = models.IntegerField(
        default=0,
        verbose_name="Número de Augmentações Geradas"
    )
...
class HistoricoTreino(models.Model):
    """Rastreia cada treino e quais imagens foram usadas"""
    ...
    epocas = models.IntegerField(
        default=50,
        verbose_name="�pocas de Treino"
    )
    
    acuracia = models.FloatField(
        null=True,
        blank=True,
        verbose_name="Acur�cia Final"
    )
    ...
    parametros = models.JSONField(
        default=dict,
        blank=True,
        verbose_name="Par�metros do Treino"
    )
    
    observacoes = models.TextField(
        blank=True,
        default='',
        verbose_name="Observa��es"
    )
    
    class Meta:
        verbose_name = "Hist�rico de Treino"
        verbose_name_plural = "Hist�ricos de Treino"
...
class ImagemTreino(models.Model):
    """Vincula imagens ao hist�rico de treino (muitos-para-muitos com rastreamento)"""
